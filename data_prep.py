...
class CorrectSingleFiles():
    ...
    def set_data_path(self, run_flag):
        ...
        self.data_path = '{0}/{1}{2}/'.format(os.environ['GFDL_DATA'],  
                          'ITCZ-MIP_aqua_sst_soc_low_res',run_flag)
    ...
    def monthly_zm_clima(self, CC, run_flag):
...
def main():     
    ...
    make_zonal_clima = True

    CSF = CorrectSingleFiles() 
    CC = CMIP_compliant() 

    exp_list = ['_m40', '_m20', '_zero', '_p20', '_p40','_take2',
                '_m40_4CO2', '_m20_4CO2', '_zero_4xco2', '_p20_4CO2', '_p40_4CO2']
    ...
    for run_flag in exp_list:
        ...
        if do_monthly:
            if prep_files:
                ...
                CSF.monthly_zm_clima(CC, run_flag)
            else:
                print('Flag not known')
                pdb.set_trace()
        else:
